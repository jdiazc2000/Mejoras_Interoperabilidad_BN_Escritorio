...
$(document).ready(function(){  
       ...
       if(variableRecibida === "BN"){
              $('#entidaddestino').append('<img src="../../../../../../../imagenes/verTransferenciaContacto/Imgs/bnlogo.png"></img>' + '<strong style="color:rgba(39, 60, 78, 1);">' + 'Banco de la naci&oacute;n' + '</strong>')
       }else{
...
function On(){
       $(".btn2").html("CONTINUAR"+"<img src=" + "../../../../../../../imagenes/verTransferenciaContacto/Imgs/Vector.png" + ">")
...
function Off(){
       $(".btn2").html("CONTINUAR"+"<img src=" + "../../../../../../../imagenes/verTransferenciaContacto/Imgs/Vector-1.png" + ">")
