...
$(document).ready(function(){  
       ...
       if(variableRecibida === "BN"){
              $('#entidaddestino').append('<img src="../../../assets/VECTOR-ICON-MV/bnlogo.svg"></img>' + '<strong style="color:rgba(39, 60, 78, 1);">' + 'Banco de la nación' + '</strong>')
       }else{
...
$(".btn2").click(function(){
       document.location.href="../../TransferenciaACelular/TransferenciaACelular_3/index.html?variable="  + encodeURIComponent(variableRecibida)
})
