...
<html lang="en">
  ...
  <body>
    <div id="maindiv">
      <h1 style="font-family: 'daxcompact-mediumregular'; font-size: 20px;">Confirma tu afiliaci&oacute;n</h1>
      ...
      <div id="btndiv">
        ...
        <button class="btn2" disabled>QUIERO AFILIARME <img src="<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Svgs/Vector-1.svg"></button>
      </div>
    </div>
