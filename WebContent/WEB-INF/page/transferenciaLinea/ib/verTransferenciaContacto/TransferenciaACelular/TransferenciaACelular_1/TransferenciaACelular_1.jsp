...
<html lang="en">
  ...
  <h1 style="font-family: 'daxcompact-mediumregular'; font-size: 20px;margin-bottom: 19px;">TRANSFIERE A</h1>
    ...
    if (checkboxValueAEnviar != "")
      $(".btn2").html("CONTINUAR" +"<img src=" +"<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/Vector.png" +">");
    ...
    function Off() {
    $(".btn2").html("CONTINUAR" +"<img src=" +"<%=request.getContextPath()%>/imagenes/verTransferenciaContacto/Imgs/Vector-1.png" +">");
