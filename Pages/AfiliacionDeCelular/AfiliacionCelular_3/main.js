...
function On(){
       $(".btn2").html("QUIERO AFILIARME"+"<img src=" + "../../../assets/VECTOR-ICON-MV/Vector.svg" + ">")
...
function Off(){
       $(".btn2").html("QUIERO AFILIARME"+"<img src=" + "../../../assets/VECTOR-ICON-MV/Vector-1.svg" + ">")
...
$(".btn2").click(function(){
       document.location.href="../AfiliacionCelular_4/"
})
